...
const GET_CARDS_FROM_GREENLIGHT_LIST = `/1/lists/${GREENLIGHT_LIST_ID}/cards`;
//add ?fields=name,desc,due to get specific fields only
const UPDATE_REQUEST_LIST_ID = "5b0734d86abee8350c62ab29";
const GET_CARDS_FROM_UPDATE_REQUEST_LIST = `/1/lists/${UPDATE_REQUEST_LIST_ID}/cards`;
const DEAL_DESK_LIST_ID = "5b44ef57881fb70345ed8428";
const GET_CARDS_FROM_DEAL_DESK_LIST = `/1/lists/${DEAL_DESK_LIST_ID}/cards`;
const REVS_FROM_AUTHOR_LIST_ID = "54662de0da8604d37ec7dadf";
const GET_CARDS_FROM_REVS_FROM_AUTHOR_LIST = `/1/lists/${REVS_FROM_AUTHOR_LIST_ID}/cards`;
const REVIEW_BY_CL_LIST_ID = "54662de33dc0248cbaa7393b";
const GET_CARDS_FROM_REVIEW_BY_CL_LIST = `/1/lists/${REVIEW_BY_CL_LIST_ID}/cards`;
const CL_IN_PROGRESS_LIST_ID = "54662de592e0840d9e46e6a7";
const GET_CARDS_CL_IN_PROGRESS_LIST = `/1/lists/${CL_IN_PROGRESS_LIST_ID}/cards`;
const FOLLOWUP_REQ_LIST_ID = "546e652160ccdd0a3c7cb76b";
const GET_CARDS_FOLLOW_UP_REQ_LIST = `/1/lists/${FOLLOWUP_REQ_LIST_ID}/cards`;
const SOW_PENDING_LIST_ID = "54662e487bae60f2e8f730f6";
const GET_CARDS_SOW_PENDING_LIST = `/1/lists/${SOW_PENDING_LIST_ID}/cards`;
const ON_HOLD_LIST_ID = "54861b6695e42d55ce6de7f2";
const GET_CARDS_ON_HOLD_LIST = `/1/lists/${ON_HOLD_LIST_ID}/cards`;
